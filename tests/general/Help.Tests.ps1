...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\xelionmgmt\functions", "$global:testroot\..\xelionmgmt\internal\functions"),
	
	[string]
	$ModuleName = "xelionmgmt",
...
$CommandPath = @(
    "$global:testroot\..\xelionmgmt\functions"
    "$global:testroot\..\xelionmgmt\internal\functions"
)

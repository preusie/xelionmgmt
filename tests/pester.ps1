...
Remove-Module xelionmgmt -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\xelionmgmt\xelionmgmt.psd1"
Import-Module "$PSScriptRoot\..\xelionmgmt\xelionmgmt.psm1" -Force
